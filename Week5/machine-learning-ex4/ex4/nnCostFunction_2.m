...
z_2 = Theta1*X(i,:)';
activation_layer_2 = [1;sigmoid(z_2)];
%activation_layer_2=[1 ; activation_layer_2];
%fprintf('%f   activation_layer_2\n' ,size(activation_layer_2));


%fprintf('%f   activation_layer_2\n' ,size(activation_layer_2));

z_3 = Theta2*activation_layer_2 ;
activation_layer_3 = sigmoid(z_3);
%fprintf('%f   activation_layer_3\n' ,size(activation_layer_3));
...
error_2 = ( Theta2_wo_bias' * error_3 ) .* sigmoidGradient(z_2);
